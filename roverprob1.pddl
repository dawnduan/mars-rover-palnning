...
(define (problem      roverprob1)
    ...
    (:init  (at r0 l3) (has-cap r0 soil) (has-cap r0 rock) (has-cap r0 image) 
            (no-data r0 empty) (no-sample r0 empty)
            (path r0 l3 l0) (path r0 l0 l3) (path r0 l3 l1) 
            (path r0 l1 l3) (path r0 l1 l2) (path r0 l2 l1)   
    )
    (:goal  (and (Earth-has l2 soil) (Earth-has l3 rock) (Earth-has l1 image) ))    
)
