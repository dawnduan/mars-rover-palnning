...
(define (problem      roverprob5adl)
(:domain    roveradl)
(:objects 
r0 r1 r2    - ROVER
l0 l1 l2 l3 l4 l5    - LOCATION)
(:init        (at r0 l2) (no-data r0 emp) (no-sample r0 emp)
        (has-cap r0 soil) (has-cap r0 rock) (has-cap r0 img)
...
(path r0 l3 l2) (path r0 l2 l5) (path r0 l5 l2) (path r0 l0 l4) (path r0 l4 l0)
        ...
        (at r1 l3) (no-data r1 emp) (no-sample r1 emp)
        (has-cap r1 rock)
...
(path r1 l3 l4) (path r1 l0 l1) (path r1 l1 l0) (path r1 l0 l5) (path r1 l5 l0)
            ...
            (at r2 l3) (no-data r2 emp) (no-sample r2 emp)
        (has-cap r2 soil) (has-cap r2 rock) (has-cap r2 img)
